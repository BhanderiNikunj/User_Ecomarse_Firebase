...
import 'package:ecomarse_firebase/Screen/ShowProduct/Controllor/ShowProductControllor.dart';
            ...
            Center(
              child: Column(
                ...
                children: [
                  InkWell(
                    onTap: () {
                      if (homeModel.isButton == true) {
                        Get.snackbar(
                            "You Have Already Click One Time", "message");
                      } else {
                        ...
                        //   key: homeModel.key,
                        //   brand: homeModel.brand,
                        //   stoke: homeModel.stoke,
                        //   isButton: true,
                        // );
                        homeModel.isButton = true;
                        showProductControllor.insertCart(
                          h1: homeModel,
                        );
                      }
                    },
